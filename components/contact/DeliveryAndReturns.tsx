...
export default function DeliveryAndReturns() {
  return (
    <section className="w-full bg-[#FDFDFD] py-[120px]">
      <div className="max-w-[1200px] mx-auto px-[5vw]">
        ...
        >
          ...
          <motion.div variants={fadeUp} className="flex flex-col gap-8">
            <h2 className="text-[#1C1C1C] font-sans text-[24px] font-bold tracking-wide uppercase border-b border-[#1C1C1C] pb-4">
              Delivery
            </h2>
            <div className="flex flex-col gap-6 text-[#333333] text-[15px] leading-[1.8] font-medium">
              <p>
          ...
          <motion.div variants={fadeUp} className="flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-6 text-[#333333] text-[15px] leading-[1.8] font-medium">
              ...
              <p className="text-[#8A8A8A] text-[14px]">
                To report an issue, please contact us at: <a href="mailto:support@motherofflower.com" className="text-[#1C1C1C] hover:text-[#C9A96E] transition-colors">support@motherofflower.com</a>
              </p>
              <p className="text-[#8A8A8A] text-[14px]">
